...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  DISCUSSION_CREATED: "Tartışma açıldı",
  DISCUSSION_UPDATED: "Tartışma güncellendi",
  DISCUSSION_REMOVED: "Tartışma kaldırıldı",
  DISCUSSION_REPLY_CREATED: "Tartışmaya yanıt",
  DISCUSSION_REPLY_REMOVED: "Yanıt kaldırıldı",
